...
def _mask_tokens(
    inputs: torch.Tensor, tokenizer: PreTrainedTokenizer, mlm_probability: float = 0.15) -> Tuple[torch.Tensor, torch.Tensor]:
...
def mask_tokens(inputs: torch.Tensor, tokenizer: PreTrainedTokenizer, mlm_probability: float = 0.15):
    return _mask_tokens(inputs=inputs, tokenizer=tokenizer, mlm_probability=mlm_probability)