...
class SeqTCNGDTEncoder(nn.Module):
    def __init__(self, config):
        ...
        self.node_embedder = SeqGNNEmbeddings(vocab_size=self.config.seq_gnn_vocab_size,
                                              ...
                                              hidden_size=self.config.seq_gnn_hidden_dim)
        self.tcn_encoder = TCNWrapper(c_in=self.config.seq_gnn_hidden_dim, layers=[self.config.tcn_hid_dim] * self.config.tcn_layers,
